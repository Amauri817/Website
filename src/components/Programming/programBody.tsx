        ...
        <body id="hello">
            <div className="container" >
                ...
                <p>
                    ...
                    I am equally familiar with the front-end and back-end of programming, knowledgeable with full stack, and have experience with both client and server side data. 
